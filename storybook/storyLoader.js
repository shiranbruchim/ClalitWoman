...
function loadStories() {
  ...
  require('../src/components/BottomMenu/BottomMenu.stories');
  ...
  require('../src/components/QuestionCard/QuestionCard.stories');
  require('../src/components/QuestionierList/QuestionierList.stories');
  require('../src/components/Questionnaire/Questionnaire.stories');
  require('../src/components/QuestionnaireStep/QuestionnaireStep.stories');
  ...
  require('../src/pages/Splash/Splash.stories');
}

const stories = [
  '../src/components/Avatar/Avatar.stories',
  '../src/components/BottomMenu/BottomMenu.stories',
  ...
  '../src/components/QuestionCard/QuestionCard.stories',
  '../src/components/QuestionierList/QuestionierList.stories',
  '../src/components/Questionnaire/Questionnaire.stories',
  '../src/components/QuestionnaireStep/QuestionnaireStep.stories',
  ...
  '../src/pages/Splash/Splash.stories',
];
